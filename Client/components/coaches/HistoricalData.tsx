...
const HistoricalData = ()=>{
    ...
    return(
        <View className="p-4 bg-gray-50 pt-[4rem] min-h-screen">
            <Text className="text-4xl font-bold mb-6 mt-4 text-center">{date}</Text>
            ...
            (Object.keys(historicalData).map((groupId) => (
                <View key={groupId} className="bg-white rounded-xl shadow-md p-5 mb-6">
